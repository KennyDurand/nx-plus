...
import { getProjectRoot } from '@nx-plus/nuxt/src/utils'
import { modifyTypescriptAliases } from '@nx-plus/nuxt/src/webpack'
import { StaticBuilderSchema } from '@nx-plus/nuxt/src/builders/static/schema'
